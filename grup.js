  ...
  const grups = [
    {
      ...
      Dicta est at illo cum nisi!  ipsa, distinctio dolor eligendi commodi excepturi cum saepe! Aliquid quas quibusdam at optio possimus repellat, magni assumenda aut ratione velit blanditiis quaerat illum?
    ...
    },
    {
      ...
      Provident  voluptates aliquid voluptatibus alias. Assumenda, quibusdam? Necessitatibus, nostrum. Nesciunt qui pariatur a?`,
      img: "http//xxxxx",
      tag: ["esport", "salut"],
    },
    {
...
amigosGuardados = JSON.parse(localStorage.getItem("amigosData"));
gruposGuardados = JSON.parse(localStorage.getItem("gruposData"));

document.addEventListener("DOMContentLoaded", function () {
  let grupoSelect = document.getElementById("grupos");
  let amicSelect = document.getElementById("amigos");
